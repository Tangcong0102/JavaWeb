...
<div class="n-head">
    <div class="g-doc f-cb">
        <div class="user">
            ...
            请<a href="./view/login.jsp">[登录]</a>
        </div>
        <ul class="nav">
            <li><a href="./view/index.jsp">首页</a></li>
            <li><a href="./view/account.jsp">账务</a></li>
            <li><a href="./view/public.jsp">发布</a></li>
            <li><a href="./view/settleAccount.jsp">购物车</a></li>
        </ul>
    </div>
</div>
<div class="g-doc">
    <div class="m-tab m-tab-fw m-tab-simple f-cb">
        <div class="tab">
            <ul>
                <li class="z-sel"><a href="./view/index.jsp">所有内容</a></li>
                <li><a href="./view/index.jsp">未购买的内容</a></li>
            </ul>
        </div>
    </div>
    <div class="n-plist">
        <ul class="f-cb" id="plist">
            <li id="p-1">
                <a href="./view/show.jsp" class="link">
